// Contact.jsx - Updated with GitHub and WhatsApp links
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <div className="space-y-1">
                    <a href="https://github.com/JitheeshJames" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-600 hover:underline block">
                      github.com/JitheeshJames
                    </a>
                    <a href="https://github.com/jitheeshjames96" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-600 hover-underline block">
                      github.com/jitheeshjames96
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <a 
                    href={`https://wa.me/919846278548?text=Hi%20Jitheesh,%20I'm%20interested%20in%20your%20portfolio`} 
                    target="_blank" 
